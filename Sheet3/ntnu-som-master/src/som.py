...
def main():
    data_set, n_neurons, iterations, k, plot_k, neighborhood, learning_rate , radius = get_input()
    ...
    som(neurons, cities, iterations, k, plot_k, neighborhood, learning_rate, radius,scaling)
